...
> This document explains **how** we ship {{projectName}} to users, keep it running, and recover when things go wrong.
...
Dashboards live in Grafana folder "{{projectName}}". PagerDuty rotation: _backend-oncall_.
